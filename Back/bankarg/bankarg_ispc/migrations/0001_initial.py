...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='persona',
            name='id_tipo_doc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bankarg_ispc.documentos'),
        ),
        migrations.AddField(
            model_name='persona',
            name='cod_loc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bankarg_ispc.localidades'),
        ),
        migrations.CreateModel(
            name='Prestamos',
            fields=[
